    ...
    <main className="min-h-screen bg-[var(--color-background)]">
      ...
      <section className="py-24 px-4 bg-[var(--color-secondary)]/10 relative overflow-hidden">
        <div className="max-w-5xl mx-auto text-center relative">
          ...
          <div className="mt-12 flex justify-center items-center space-x-8 animate-fadeIn animation-delay-500">
              ...
              >
                <div className="bg-[var(--color-background)] rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border border-[var(--color-primary)]/10">
                  <div className="relative h-80 overflow-hidden">
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-[var(--color-background)]/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                  </div>
                  <div className="p-6 text-center">
                    ...
                    <p className="text-[var(--color-text-secondary)] text-sm leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-500 max-h-0 group-hover:max-h-40">
                      {member.bio}
                    </p>
